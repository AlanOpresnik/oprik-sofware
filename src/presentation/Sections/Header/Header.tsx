...
const Header = () => {
    return (
        <header className="text-white md:flex justify-between mt-20  items-center   ">
            <div className="mt-16">
                <p className="text-xl text-[#FEF08A]  font-semibold">
                    Oprik Software
                </p>
                <p className="text-5xl md:text-6xl mb-4 font-bold">Convertimos tus ideas en <span className="text-[#FEF08A]">realidad</span></p>
                ...
                <div className="flex gap-3">
                    ...
                    <button className="mt-4 border px-2 py-2 flex items-center gap-2 hover:bg-slate-100 hover:text-black transition-colors  rounded-xl">
            ...
            <div className="relative shake-animation">
                ...
                <div className="absolute top-20 left-40">
                    <Image alt="Imagen codigo" src={'/code2.png'} width={500} height={500} />
                </div>
