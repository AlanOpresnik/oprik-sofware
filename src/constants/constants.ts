...
export const generateWhatsAppLink = (courseTitle: string, price: number, startDate: string, endDate: string, duration: string, schedule: string) => {
