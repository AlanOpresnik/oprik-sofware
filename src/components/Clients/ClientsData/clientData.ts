export const cardData = [
    ...
    },
    {
        ...
        personRole: 'Lore Cunas',
        founder: 'Fundadora de ',
    ...
    {
        overview: 'Nosotros hicimos un sitio para nuestra casa de alquiler y ninguna queja, muy buen rendimiento y adminsitracion, siempre muy atentos a las necesidades que tuvimos. muy conformes',
        name: 'Diego Opresnik',
    ...
    {
        overview: 'Necesitamos una web para poder vender en linea, nos contactamos con ellos y en menos de un mes tuvimos nuestra web funcionando a la perfeccion, un lujo, muy recomendados, un hambiente muy profesional.',
        name: 'Facundo Sanchez',
        image: 'https://www.portaflex.com.ar/assets/logo-vEuOhYIL.png',
        founder: 'Fundador de ',
        personRole: 'Portaflex Argentina ',
    ...
    {
        overview: 'Muy profesionales con todo el trabajo , siempre a dispocicion de lo que necesitabamos,estamos muy conformes con el resultado.',
        name: 'Mauricio',
        image: 'https://static.wixstatic.com/media/144b07_5342ef7bd6864624b8b53148f42bbb8f~mv2.png/v1/crop/x_17,y_0,w_754,h_215/fill/w_304,h_77,al_c,q_85,usm_0.66_1.00_0.01,enc_avif,quality_auto/144b07_5342ef7bd6864624b8b53148f42bbb8f~mv2.png',
        founder: 'Fundador de ',
        personRole: 'Duracril ',
        web: 'https://www.duracril.net/',
        webImg: 'https://res.cloudinary.com/dbgt948uj/image/upload/c_crop,w_1220,h_1080/v1737402503/WhatsApp_Image_2025-01-20_at_16.46.19_mgpgon.jpg',
