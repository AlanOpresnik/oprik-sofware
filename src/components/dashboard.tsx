                ...
                <div className="">
                  <div className="  ">
                    <div className="relative">
                      <div className="text-5xl font-bold">Plan <span className='text-primary'>{order.data?.client.order.plan_name}</span></div>
                      <div>
                        ...
                        <p className="text-xl font-bold mt-4">Compra hecha a nombre de<span className='text-primary'> Julian mercedes</span></p>
                        <p className="text-xl font-bold mt-4">Metodo de pago<span className='text-primary'> Mercado pago</span></p>
                        <p className="text-xl font-bold mt-4">Estado del pago<span className='text-primary'> Exitoso</span></p>
